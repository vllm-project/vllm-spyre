...
class SpyreRMSNorm(RMSNorm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.prefix = register_in_static_context(self, "spyre_rmsnorm")
...
def register():
    ...
    Registers torch.ops.vllm.spyre_rmsnorm with:
        - op_func: Actual implementation (generated by create_rmsnorm_op_pair)
        - fake_impl: Shape inference implementation (generated by create_rmsnorm_op_pair)
        - mutates_args: Indicates 'output' is modified in-place
    """
    op_func, fake_impl = create_rmsnorm_op_pair()
