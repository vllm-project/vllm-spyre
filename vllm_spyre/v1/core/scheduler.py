    ...
    def schedule(self) -> "SchedulerOutput":
        ...
        if not preempted_reqs:
            while self.waiting and token_budget > 0:
                ...
                # Only pull from waiting queue if all running requests have finished (spyre constraint)
                ...
                # spyre warmup shapes
                max_tokens = 0
                currently_scheduled_reqs = scheduled_resumed_reqs + scheduled_running_reqs
                ...
                if not updated_spyre_warmup_shapes:
                    if not currently_scheduled_reqs:
                        ...
                        break
                        # (This break will prevent anything else in the waiting queue from scheduling this step- but looks like the v1 scheduler currently does that for most cases)
                else:
